...
<ul class="social-accounts-list inline-list inline-list--ib">
	...
	<li class="social-icons__item social-icons__item--facebook">
		<a href="<?php echo $facebook_url ?>" target="_blank" class="social-icons__link icon-fallback-text" title="<?php echo $site_name_filter; ?> Facebook account">
	...
	<li class="social-icons__item social-icons__item--twitter">
		<a href="https://twitter.com/#!/<?php echo $twitter_url ?>" target="_blank" class="social-icons__link icon-fallback-text" title="<?php echo $site_name_filter; ?> Twitter account">
	...
	<li class="social-icons__item social-icons__item--vimeo">
		<a href="<?php echo $vimeo_url ?>" target="_blank" class="social-icons__link icon-fallback-text" title="<?php echo $site_name_filter; ?> Vimeo account">
	...
	<li class="social-icons__item social-icons__item--instagram">
		<a href="<?php echo $instagram_url ?>" target="_blank" class="social-icons__link icon-fallback-text" title="<?php echo $site_name_filter; ?> Instagram account">
	...
	<li class="social-icons__item social-icons__item--youtube">
		<a href="<?php echo $youtube_url ?>" target="_blank" class="social-icons__link icon-fallback-text" title="<?php echo $site_name_filter; ?> YouTube account">
	...
	<li class="social-icons__item social-icons__item--linkedin">
		<a href="<?php echo $linkedin_url ?>" target="_blank" class="social-icons__link icon-fallback-text" title="<?php echo $site_name_filter; ?> LinkedIn account">
	...
	<li class="social-icons__item social-icons__item--google-plus">
		<a href="<?php echo $google_url ?>" target="_blank" class="social-icons__link icon-fallback-text" title="<?php echo $site_name_filter; ?> Google Plus account">
