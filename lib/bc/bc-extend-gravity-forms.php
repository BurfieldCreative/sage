 ...
 */
function bc_add_form_event_tracking($button, $form) {
...
add_filter("gform_submit_button", "bc_add_form_event_tracking", 10, 2);
 ...
 */
function bc_form_submit_button ( $button, $form ) {
...
add_filter( 'gform_submit_button', 'bc_form_submit_button', 10, 2 );
